  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20 relative">
        ...
        {/* Speed lines */}
        <div className="absolute left-0 top-1/4 w-40 h-1 bg-gradient-to-r from-[var(--comic-red)] to-transparent" />
        <div className="absolute left-0 top-1/3 w-60 h-1 bg-gradient-to-r from-foreground/30 to-transparent" />
        <div className="absolute right-0 bottom-1/4 w-40 h-1 bg-gradient-to-l from-[var(--comic-red)] to-transparent" />
        <div className="absolute right-0 bottom-1/3 w-60 h-1 bg-gradient-to-l from-foreground/30 to-transparent" />
        ...
        <div className="text-center max-w-6xl mx-auto relative z-10">
          ...
          <div className="mb-8 inline-block bg-card border-4 border-foreground p-4 shadow-[6px_6px_0_var(--foreground)] -rotate-1">
            <p className="text-xl md:text-2xl lg:text-3xl font-bold uppercase tracking-wide text-foreground flex items-center gap-3">
              <Zap className="w-8 h-8 text-[var(--comic-red)]" />
              OFFLINE HACKATHON
              <Zap className="w-8 h-8 text-[var(--comic-red)]" />
            </p>
          </div>
          ...
          <div className="mb-10 space-y-4">
            <a
              ...
              className="inline-flex items-center gap-3 bg-[var(--comic-yellow)] border-4 border-foreground px-6 py-3 shadow-[4px_4px_0_var(--foreground)] rotate-1 hover:-translate-y-1 hover:-translate-x-1 transition-all"
            >
          ...
          <div className="absolute -top-10 -right-10 w-24 h-24 border-4 border-foreground bg-[var(--comic-blue)] opacity-50 rotate-12 animate-comic-float" />
          <div
            className="absolute -bottom-10 -left-10 w-20 h-20 border-4 border-foreground bg-[var(--comic-red)] opacity-50 -rotate-12 animate-comic-float"
