...
const links = [
  ...
  { icon: Github, label: "Github", href: "https://github.com/Build-Ora", description: "View github" },
  { icon: Users, label: "Discord", href: "https://discord.gg/T2SJUyWp", description: "Join our community" },
  { icon: MessageSquare, label: "WhatsApp", href: "https://chat.whatsapp.com/FDAWxG0EiujB1LjRIRmyVu", description: "Get instant updates" },
]


export function LinksSection() {
  return (
    <section className="relative py-20 px-4 bg-[var(--comic-red)]/10 border-t-4 border-foreground">
          ...
          {links.map((link, index) => (
            <a key={link.label} href={link.href} className="block group">
              <ComicCard variant="default" rotate={(index % 2 === 0 ? -1 : 1) * 2} className="text-center h-full">
                <div className="inline-block p-3 bg-[var(--comic-yellow)] border-4 border-foreground mb-4 transition-transform group-hover:rotate-12">
